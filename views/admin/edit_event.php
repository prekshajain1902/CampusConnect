...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt->execute()) {
        header("Location: manage_events?success=Event updated successfully");
        exit();
    } else {
        ...
        <div class="card p-4 shadow">
            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                   ...
                   <?php 
$image_path = "../../" . $event['image_path']; // Ensure correct path

if (!empty($event['image_path']) && file_exists($image_path)) { ?>
    <img src="<?php echo $image_path; ?>" class="event-image" alt="Event Image">
<?php } else { ?>
    <span class="text-muted">⚠️ No Image Available</span>
<?php } ?>
                ...
                <div class="d-grid gap-2">
                    ...
                    <a href="manage_events" class="btn btn-secondary">Back to Events</a>
